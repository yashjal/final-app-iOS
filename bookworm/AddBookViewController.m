...
//        [myAlertView show];
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Error: No access to camera" message:@"Device has no camera" preferredStyle:UIAlertControllerStyleAlert];
